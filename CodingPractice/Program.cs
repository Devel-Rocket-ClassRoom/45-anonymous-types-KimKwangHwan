...
{
    var item = new { Name = "사과", Quantity = 10 };
...
}
{
    ...
    PrintPersonDynamic(person);
}

{
    var annoymousPerosn = new { Name = "홍길동", Age = 30 };
    var tuplePerson = (Name: "홍길동", Age: 30);

    Console.WriteLine($"익명 타입: {annoymousPerosn.Name}, {annoymousPerosn.Age}");
...

{
    var employees = new[]
    {
        ...
        new { Name = "박민수", Department = "개발팀", Salary = 5400}
    };
...
{
    return new { Name = "홍길동", Age = 30 };
}
void PrintPersonDynamic(dynamic person)
{
    Console.WriteLine($"{person.Name}, {person.Age}");
}